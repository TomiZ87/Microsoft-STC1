...
// In this calculator you enter 2 numbers and a operator and the calculator will calculate it for you
...
switch(operator) //After all necessary data is taken, I used the switch to decide which operator will be used for the equation
{
    case '+':  //If the operator is +, then the addition will happen.
        ...
        console.log("Result: " +(firstNumber) + "+" + (secondNumber) + "=" + (result)) // then I printed the calculated equation
        break; //to not repeat the duplication of equation with other operators, I closed the switch
